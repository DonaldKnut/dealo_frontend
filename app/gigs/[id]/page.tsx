...
import Carousel from "@/components/FreelanceComponents/Carousel/Carousel";
import AboutSeller from "@/components/FreelanceComponents/AboutSeller/AboutSeller";
...
const Gig = () => {
  return (
    <div className="gig-parent text-white">
      ...
      <div className="user-section">
        ...
        />
        <span className="username">Bash Alli</span>
        <div className="stars">
